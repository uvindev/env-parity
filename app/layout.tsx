...
export const metadata: Metadata = {
  ...
  title: "EnvParity — check Vercel environment coverage before release",
  description:
    "Compare source environment dependencies with development, preview, and production key scopes without uploading values.",
